import{_ as o}from"./AppButton-BwJ1GXIp.js";import"./iframe-DVBV3JlS.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"Components/AppButton",component:o,tags:["autodocs"],argTypes:{color:{control:"text"},variant:{control:{type:"select",options:["elevated","flat","tonal","outlined","text","plain"]}},default:{control:"text"}}},n={args:{color:"primary",default:"Primary Button"},render:t=>({components:{AppButton:o},setup(){return{args:t}},template:'<AppButton v-bind="args">{{ args.default }}</AppButton>'})},r={args:{color:"secondary",default:"Secondary Button"},render:t=>({components:{AppButton:o},setup(){return{args:t}},template:'<AppButton v-bind="args">{{ args.default }}</AppButton>'})},e={args:{color:"primary",variant:"outlined",default:"Outlined Button"},render:t=>({components:{AppButton:o},setup(){return{args:t}},template:'<AppButton v-bind="args">{{ args.default }}</AppButton>'})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'primary',
